...
def render_importer_view():
    ...
    with tab1:
        st.warning("Using patched importer scenario logic. If liability appears unchanged, select Chart basis = Baseline vs selected volume or Scenario CBAM by supplier.")
        st.caption(
